                            ...
                            <section class="page-section bg-light">
                                <div class="container">
                                    <div class="text-center">
                                        <h2 class="section-heading text-uppercase">Confirm Booking</h2>
                                    </div>
                                    <div class="row">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="relative flex items-center">
                                                        <form action="{{ route('bookings.unconfirm', $data->booking_order_id)}}" method="POST" style="display:inline;">
                                                          ...
                                                          @method('PATCH')
                                                        <button
                                                            class="inline-flex items-center mr-2 px-3 py-1 bg-red-600 transition ease-in-out delay-75 hover:bg-red-700 text-white text-sm font-medium rounded-md hover:-translate-y-1 hover:scale-110"
                                                            type="submit">Decline</button>
                                                        </form>
                                                        <form action="{{ route('bookings.confirm', $data->booking_order_id)}}" method="POST" style="display:inline;">
                                                          @csrf
                                                          @method('PATCH')
                                                        <button
                                                            class="inline-flex items-center px-3 py-1 bg-green-600 transition ease-in-out delay-75 hover:bg-green-700 text-white text-sm font-medium rounded-md hover:-translate-y-1 hover:scale-110"
